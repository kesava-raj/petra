...
export const voiceConfig: VoiceConfig = {
  ...
  phoneNumber: import.meta.env.VITE_AGENT_PETTRA_PHONE_NUMBER || '+18557388721',
  displayPhoneNumber: '+1 (855) 738-8721',
  suggestedPrompts: [
  ...
  simulatedGreeting: "Hi! You are speaking with Agent Pettra, an AI receptionist. How can I assist you with scheduling or questions today?",
  simulatedResponses: [
    {
